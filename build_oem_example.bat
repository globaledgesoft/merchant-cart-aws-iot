...
set TOOL_PATH_ROOT="C:\Program Files (x86)"
set TOOLCHAIN_PATH="C:\Program Files (x86)\ARM_Compiler_5\bin"
set LM_LICENSE_FILE=C:\Program Files (x86)\ARM_Compiler_5\DS-5 Ultimate Edition (30-day Evaluation).lic
...
if "%1%"=="-c" (
	...
	REM Example for sub_pub
    echo == Compiling %1% example ...
    set BUILD_APP_FLAG=-D__EXAMPLE_SUB_PUB__
) else if "%1%"=="help" (
    goto help_menu
) else if "%1%"=="HELP" (
    goto help_menu
